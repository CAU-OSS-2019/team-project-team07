...
class Ui_SubWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.lblFirstChar.setGeometry(QtCore.QRect(10, 80, 120, 16))
        ...
        self.lblFirstOver.setGeometry(QtCore.QRect(10, 150, 180, 16))
        self.lblFirstOver.setObjectName("lblFirstOver")
        self.lblSndOver = QtWidgets.QLabel(self.groupBox)
        self.lblSndOver.setGeometry(QtCore.QRect(10, 300, 180, 16))
        ...
        self.lblSndChar.setGeometry(QtCore.QRect(10, 230, 120, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblTargetNum.setText(_translate("MainWindow", "target"))
        for i in range(1,22):
        ...
        self.lblFirstChar.setText(_translate("MainWindow", "first character"))
        self.btnFirst.setText(_translate("MainWindow", "Browser..."))
        self.btnFirstOver.setText(_translate("MainWindow", "Browser..."))
        self.lblFirstOver.setText(_translate("MainWindow", "first overlap character"))
        self.lblSndOver.setText(_translate("MainWindow", "second overlap character"))
        self.btnSndOver.setText(_translate("MainWindow", "Browser..."))
        self.btnSnd.setText(_translate("MainWindow", "Browser..."))
        self.lblSndChar.setText(_translate("MainWindow", "second character"))
        self.btnTrans.setText(_translate("MainWindow", "create"))
        self.groupBox_2.setTitle(_translate("MainWindow", "result"))
        self.btnSave.setText(_translate("MainWindow", "save"))
        self.btnSol.setText(_translate("MainWindow", "result"))
